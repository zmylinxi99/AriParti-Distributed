...
void env_params::collect_param_descrs(param_descrs & d) {
    ...
    d.insert("bicp_enabled", CPK_BOOL, "AriParti enable Boolean and interval constraint propagation", "true");
    d.insert("clause_reduction_enabled", CPK_BOOL, "AriParti enable theory-level clause reduction", "true");
}
